...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    illustration:
      '<svg viewBox="0 0 600 200" width="100%" height="100%" role="img" aria-label="Risk trending down from baseline through today toward a projected target within appetite"><rect x="420" y="132" width="120" height="50" rx="6" fill="#e4edff"/><line x1="60" y1="178" x2="540" y2="178" stroke="#e3e6ec"/><polyline points="90,40 160,52 230,48 300,90" fill="none" stroke="#1a2138" stroke-width="2.6" stroke-linejoin="round" stroke-linecap="round"/><polyline points="300,90 400,122 510,150" fill="none" stroke="#4d8bff" stroke-width="2.6" stroke-linejoin="round" stroke-linecap="round" stroke-dasharray="5 6"/><circle cx="90" cy="40" r="6" fill="#1a2138"/><circle cx="300" cy="90" r="8" fill="#4d8bff" stroke="#fff" stroke-width="3"/><circle cx="510" cy="150" r="8" fill="#fff" stroke="#4d8bff" stroke-width="3"/><text x="90" y="22" text-anchor="middle" font-family="inherit" font-size="13" font-weight="600" fill="#5b6577">Baseline</text><text x="300" y="66" text-anchor="middle" font-family="inherit" font-size="14" font-weight="600" fill="#1a2138">Today</text><text x="510" y="122" text-anchor="middle" font-family="inherit" font-size="14" font-weight="600" fill="#2f5bb0">Target</text><text x="480" y="192" text-anchor="middle" font-family="inherit" font-size="13" font-weight="500" fill="#2f5bb0">Within appetite</text></svg>',
  },
];
